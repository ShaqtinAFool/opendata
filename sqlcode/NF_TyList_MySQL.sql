...
# offical major information
CREATE TABLE OfficalInfo (
	o_info_id INT AUTO_INCREMENT,
...
# Offical detail information
CREATE TABLE OfficalContent (
	o_cont_id INT AUTO_INCREMENT,
	o_info_id INT NOT NULL,
	...
	PRIMARY KEY (`o_cont_id`),
	FOREIGN KEY (o_info_id) REFERENCES OfficalInfo(o_info_id)
) DEFAULT CHARSET = utf8;
